...
const FieldRegistry = [
  ...
  },
  {
    ...
    profilePath: 'organization.ein',
    label: 'EIN',
    labels: ['EIN', 'ein', 'ein number', 'ein tax id', 'employer identification number'],
    synonyms: ['ein', 'ein number', 'ein tax id', 'employer identification number'],
    aliases: ['ein', 'ein number', 'ein tax id', 'employer identification number'],
    context: 'organization',
    valueType: 'string',
    fieldType: 'text',
    acceptedControlTypes: ['text', 'email', 'tel', 'url', 'number', 'textarea'],
