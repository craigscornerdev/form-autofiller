...
## Corpus Check
- 31 files · ~24,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 266 nodes · 306 edges · 22 communities (18 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a408b78f`
...
Cohesion: 0.10
Nodes (19): 0.10.0 — 2026-08-27 — Gradient + fill-policy helpers, 0.11.0 — 2026-08-27 — Numeric confidence through the matcher, 0.12.0 — 2026-08-27 — Render the confidence spectrum, 0.12.1 — 2026-08-27 — Keep the popup's script wiring honest, 0.13.0 — 2026-08-28 — FieldConcept schema + registry loader, 0.15.0 — 2026-08-28 — One canonical label normalizer, 0.1.0 — 2026-08-21 — First extension shell, 0.1.1 — 2026-08-21 — Scan the open page (+11 more)
...
Cohesion: 0.15
Nodes (6): ConfidenceGradient, FieldMatcher, FuzzyFieldMatcher, FieldMatcher, FuzzyFieldMatcher, LabelNormalizer

### Community 13 - "Community 13"
Cohesion: 0.20
Nodes (10): LocationCountries, LocationData, FieldMatcher, fs, loadBrowserContext(), { LocationData }, path, popupDependencyScripts() (+2 more)
...
## Knowledge Gaps
- **139 isolated node(s):** `VALUE_TYPES`, `FILL_POLICIES`, `ConceptRegistry`, `ConfidenceGradient`, `FillPolicy` (+134 more)
